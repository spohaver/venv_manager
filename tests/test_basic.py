...
class TestFileStructure:
    ...
    def test_required_files_exist(self):
        ...
        for filename in required_files:
            assert (self.project_root / filename).exists(), f"Missing required file: {filename}"
